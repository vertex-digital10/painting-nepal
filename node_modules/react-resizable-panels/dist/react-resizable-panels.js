...
import { useState as Z, useCallback as ce, useId as Pt, useLayoutEffect as et, useEffect as Se, useRef as T, createContext as Lt, useContext as Ct, isValidElement as Rt, useImperativeHandle as tt, useMemo as Pe, useSyncExternalStore as nt } from "react";
function Mt(e, t) {
...
function Dt(e, t = [], n, o = !1) {
  const r = k, i = { ...k };
  i.cursorFlags = e, i.state === "active" && (i.didPointerMove ||= o, i.previews = t, n && (i.previewLayoutMap = n)), k = i, Me.emit("change", {
    prev: r,
    next: i
  });
}
...
const Gt = (e) => e, we = () => {
}, it = 1, st = 2, at = 4, lt = 8, Fe = 3, _e = 12;
let me;
function $e() {
...
function At({
  ...
  if (!(o === 0 && r === 0)) {
    switch (n) {
      case "active": {
        if (e && $e()) {
          const i = (e & it) !== 0, s = (e & st) !== 0, u = (e & at) !== 0, c = (e & lt) !== 0;
          if (i)
...
function de({
  ...
  }
  {
    ...
    for (; d >= 0 && d < n.length; ) {
      ...
      if (!D(h, x) && (y += h - x, a[d] = x, y.toFixed(3).localeCompare(Math.abs(e).toFixed(3), void 0, {
        numeric: !0
      }) >= 0))
        break;
      e < 0 ? d-- : d++;
  ...
  return D(p, 100, 0.1) ? a.reduce((g, d, v) => (g[n[v].panelId] = d, g), {}) : r;
}
function K(e, t) {
...
function ke({
  ...
  let y = 0;
  n.movementX === 0 ? y |= u & Fe : y |= c & Fe, n.movementY === 0 ? y |= u & _e : y |= c & _e;
...
function Oe(e, t) {
  ...
  return t.forEach((o, r) => {
    if (r.disabled)
      return;
    const i = Ee({ group: r }), s = Ut(r.orientation, i, {
      x: e.clientX,
      y: e.clientY
    });
...
function sn(e) {
    ...
    for (const g of p) {
      ...
      if (v === e.element) {
        if (t) {
          ...
          if (!m.defaultLayoutDeferred && K(m.layout, C) && on(
  ...
  const s = ae({ group: e }), u = Le(e), c = Qe({
    group: e,
    panelConstraints: u
  }), a = ne({
    layout: c,
  ...
  return Ee({ group: e, includeDisabled: !0 }).forEach((p) => {
    ...
    ), r.add(p.id), p.element.addEventListener("keydown", Ke);
  }), re.get(l) === 1 && (l.addEventListener("contextmenu", Ve, !0), l.addEventListener("dblclick", We, !0), l.addEventListener("pointerdown", Xe, !0), l.addEventListener("pointerleave", qe), l.addEventListener("pointermove", Ye), l.addEventListener("pointerout", Je), l.addEventListener("pointerup", Ze, !0)), function() {
    t = !1, re.set(
      l,
      ...
      Xe,
      !0
    ), l.removeEventListener("pointerleave", qe), l.removeEventListener("pointermove", Ye), l.removeEventListener("pointerout", Je), l.removeEventListener("pointerup", Ze, !0)), i.disconnect();
  };
}
function an() {
  const [e, t] = Z({}), n = ce(() => t({}), []);
...
function vt(e) {
  const { registerOverlay: t } = be(), n = T(e);
...
function un({
  ...
  ) : i && (u = /* @__PURE__ */ B(ln, { separator: i }))), /* @__PURE__ */ B(
    "div",
    {
      "aria-hidden": "true",
...
function pn({
  ...
  return V(() => {
    ...
    _.current = A;
    const $ = sn(A), { defaultLayoutDeferred: Y, derivedPanelConstraints: oe, layout: le } = Q(A.id, !0);
    ...
    const xe = Ie(m, (J) => {
      ...
      A.mutableState.layouts[St] = he, Ge.forEach((H) => {
        if (H.collapsible) {
      ...
      const Ae = q(), bt = Ae.state !== "active" || !Ae.hitRegions.some((H) => H.group === A);
...
function wn({
  ...
  const i = n !== void 0, s = "id" in r ? r.id : r.groupId, u = ve(s, n ?? []), c = nt(
    mn,
    () => o.getItem(u),
    () => o.getItem(u)
  ), a = Pe(() => {
...
function bn({
  ...
  const a = De(i), l = Ne({
    ...
    preview: s,
    style: u
  }), [f, y] = Z({}), [p, g] = Z("inactive"), [d, v] = Z(!1), h = T(null), m = T(null), x = Te(h, r), {
    disableCursor: S,
    id: P,
    orientation: C,
    registerSeparator: E,
...
export {
  ...
  wn as useDefaultLayout,
  Pn as useGroupCallbackRef,
  Ln as useGroupRef,
