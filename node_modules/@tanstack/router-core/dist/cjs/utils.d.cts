 ...
 */
export declare function replaceEqualDeep<T>(prev: any, next: T, _nullProto?: boolean, _depth?: number): T;
 ...
 */
export declare function deepEqual(a: any, b: any, partial?: boolean, explicitUndefined?: boolean): boolean;
...
export declare const protocolRelativePrefixRegex: RegExp;
/**
