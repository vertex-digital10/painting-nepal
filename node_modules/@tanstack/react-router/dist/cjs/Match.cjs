...
var Match = react.memo(function MatchImpl({ routeId }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MatchView, {
		router,
		match: (0, _tanstack_react_store.useSelector)(router.stores.getMatchStore(routeId))
	});
});
...
var Outlet = react.memo(function OutletImpl() {
	...
	if (_tanstack_router_core_isServer.isServer ?? router.isServer) {
		...
		[parentGlobalNotFound, parentNotFoundError] = (0, _tanstack_react_store.useSelector)(parentMatchStore, (match) => [!!match._notFound, match.error], { compare: outletMatchSelectionEqual });
		childRouteId = (0, _tanstack_react_store.useSelector)(router.stores.ids, (ids) => {
